...
internal class DbUpdateCheckerTest : AppTest() {
  ...
  fun testSuggestedVersion() {
    ...
    every { packageManager.getPackageInfo(packageInfo.packageName, any<Int>()) } returns packageInfo
  ...
  fun testSuggestedVersionOnlyFromPreferredRepo() {
    ...
    every { packageManager.getPackageInfo(packageName, any<Int>()) } throws NameNotFoundException()
    ...
    every { packageManager.getPackageInfo(packageName, any<Int>()) } returns
      PackageInfo().apply {
