...
public data class AppCheckResult(val updates: List<UpdatableApp>, val issues: List<AppWithIssue>)
...
/**
 * An app that can not get updated, because all versions have an incompatible signer. There may be
 * compatible versions in another repo.
 */
