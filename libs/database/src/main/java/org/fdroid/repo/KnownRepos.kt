...
/**
 * A map from canonical repo URL to lower-case fingerprint of this repo. When adding new repos here,
 * please test that adding the repo still works.
 */
internal val knownRepos =
  mapOf(
