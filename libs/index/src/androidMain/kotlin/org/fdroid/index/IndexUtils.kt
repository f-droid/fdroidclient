...
public object IndexUtils {
  ...
  /**
   * Get the standard, lowercase SHA-256 fingerprint used to represent an APK or JAR signing key.
   * **NOTE**: this does not handle signers that have multiple X.509 signing certificates.
   *
   * <p>
   * Calling the X.509 signing certificate the "signature" is incorrect, e.g.
   * [android.content.pm.PackageInfo.signatures] or [android.content.pm.Signature]. The Android docs
   * about APK signatures call this the "signer".
   *
   * @see org.fdroid.fdroid.data.Apk#signer
   * @see android.content.pm.PackageInfo#signatures
   * @see <a href="https://source.android.com/docs/security/features/apksigning/v2">APK Signature
   *   Scheme v2</a>
   */
  ...
  /**
   * Get the fingerprint used to represent an APK signing key in F-Droid. This is a custom
   * fingerprint algorithm that was kind of accidentally created. It is now here only for backwards
   * compatibility. It should only ever be used for writing the `sig` value out to `index-v1.json`.
   *
