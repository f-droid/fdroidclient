...
public abstract class IndexCreator<T>(
  ...
  @Throws(IOException::class) public abstract fun createRepo(): T
   ...
   *
   * Robolectric apparently does not support Os.symlink, and some devices might have wonky
   * implementations. Copying is slower and takes more disk space, but is much more reliable. So it
