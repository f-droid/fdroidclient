...
public data class Entry(
  ...
  /**
   * @return the diff for the given [timestamp] or null if none exists in which case the full
...
public data class FileV2(
  ...
  public companion object {
    ...
    @JvmStatic public fun fromPath(path: String): FileV2 = FileV2(path)
  }
...
@Serializable
public data class IndexV2(val repo: RepoV2, val packages: Map<String, PackageV2> = emptyMap()) {
