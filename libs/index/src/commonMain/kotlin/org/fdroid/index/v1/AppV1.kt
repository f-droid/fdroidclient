...
public data class AppV1(
  ...
  public fun toMetadataV2(preferredSigner: String?, locale: String = DEFAULT_LOCALE): MetadataV2 =
    MetadataV2(
      ...
      screenshots =
        Screenshots(
            phone = localized.toLocalizedFileListV2("phoneScreenshots") { it.phoneScreenshots },
            sevenInch =
              localized.toLocalizedFileListV2("sevenInchScreenshots") { it.sevenInchScreenshots },
            tenInch =
              localized.toLocalizedFileListV2("tenInchScreenshots") { it.tenInchScreenshots },
            wear = localized.toLocalizedFileListV2("wearScreenshots") { it.wearScreenshots },
            tv = localized.toLocalizedFileListV2("tvScreenshots") { it.tvScreenshots },
          )
          .takeIf { !it.isNull },
    )
  ...
  private fun Map<String, Localized>?.toLocalizedFileV2(
    ...
    return mapValuesNotNull {
      selector(it.value)?.let { file -> FileV2("/$packageName/${it.key}/$file") }
    }
  }
  ...
  private fun Map<String, Localized>?.toLocalizedFileListV2(
    ...
    if (this == null) return null
    return mapValuesNotNull {
      selector(it.value)?.map { file -> FileV2("/$packageName/${it.key}/$kind/$file") }
    }
  }
}
