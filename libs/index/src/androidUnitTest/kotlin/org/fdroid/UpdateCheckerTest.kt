...
internal class UpdateCheckerTest {
  ...
  fun emptyReleaseChannelsAlwaysIncluded() {
    ...
    assertEquals(version3, updateChecker.getUpdate(versions, allowedReleaseChannels = betaChannels))
  ...
  fun installedVulnerableVersionAlwaysReturned() {
    ...
    val versions = listOf(version3, version2, version1)
    assertEquals(version3, updateChecker.getUpdate(versions, includeKnownVulnerabilities = true))
    assertEquals(
      version3,
