...
internal class EntryVerifierTest {
  ...
  fun testNoCertAndFingerprintAllowed() {
    ...
    assertFailsWith<IllegalArgumentException> { EntryVerifier(file, CERTIFICATE, FINGERPRINT) }
  }
  ...
  fun testInvalid() {
    ...
    val verifier = EntryVerifier(file, null, null)
    assertFailsWith<SigningException> { verifier.getStreamAndVerify {} }
  }
  ...
  fun testWrongEntry() {
    ...
    val verifier = EntryVerifier(file, null, null)
    val e = assertFailsWith<SigningException> { verifier.getStreamAndVerify {} }
