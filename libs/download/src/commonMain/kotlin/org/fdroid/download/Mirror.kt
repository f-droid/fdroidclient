...
constructor(
  ...
  public val url: Url by lazy {
    try {
      ...
      // we fall back to a non-existent URL if someone tries to sneak in an invalid mirror URL to
      // crash us
  ...
  public companion object {
    @JvmStatic public fun fromStrings(list: List<String>): List<Mirror> = list.map { Mirror(it) }
  }
}
