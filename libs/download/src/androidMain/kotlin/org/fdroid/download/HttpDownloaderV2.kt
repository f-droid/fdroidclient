...
public class HttpDownloaderV2(
  ...
  override suspend fun getBytes(resumable: Boolean, receiver: BytesReceiver) {
  ...
  override fun totalDownloadSize(): Long = request.indexFile.size ?: -1L
