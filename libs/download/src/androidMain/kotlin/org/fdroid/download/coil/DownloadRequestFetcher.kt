 ...
 * coil-network-core/src/commonMain/kotlin/coil3/network/NetworkFetcher.kt under Apache-2.0 license.
 */
...
public class DownloadRequestFetcher(
  ...
  override suspend fun fetch(): FetchResult? {
    ...
    try {
      ...
      //  may need
      // https://github.com/Kotlin/kotlinx-io/blob/master/integration/kotlinx-io-okio/Module.md
      ...
      if (snapshot == null) {
        ...
        return SourceFetchResult(
          source =
            ImageSource(source = bufferedSource, fileSystem = FileSystem.SYSTEM, metadata = null),
          mimeType = mimeType,
  ...
  private fun writeToDiskCache(
    ...
    return try {
      fileSystem.write(editor.data) { writeAll(bufferedSource) }
  ...
  public class Factory @Inject constructor(private val httpManager: HttpManager) :
