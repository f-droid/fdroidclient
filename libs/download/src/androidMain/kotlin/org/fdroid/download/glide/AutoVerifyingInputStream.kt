...
/**
 * An [InputStream] that automatically verifies the [expectedHash] in lower-case SHA-256 format and
 * ensures that not more than [maxBytesToRead] are read from the stream. This is useful to put an
 * upper bound on data read to not exhaust memory.
 */
