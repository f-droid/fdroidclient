...
fun PackageV2.v1compat(overrideLocale: Boolean = false) =
  copy(
    metadata =
      metadata.copy(
        name = if (overrideLocale) metadata.name?.filterKeys { it == LOCALE } else metadata.name,
        summary =
          if (overrideLocale) metadata.summary?.filterKeys { it == LOCALE } else metadata.summary,
        description =
          if (overrideLocale) metadata.description?.filterKeys { it == LOCALE }
        ...
        screenshots =
          metadata.screenshots?.copy(
            phone =
              metadata.screenshots?.phone?.mapValues { list -> list.value.map { it.v1compat() } },
            sevenInch =
              metadata.screenshots?.sevenInch?.mapValues { list ->
                list.value.map { it.v1compat() }
              },
            tenInch =
              metadata.screenshots?.tenInch?.mapValues { list -> list.value.map { it.v1compat() } },
            wear =
              metadata.screenshots?.wear?.mapValues { list -> list.value.map { it.v1compat() } },
            tv = metadata.screenshots?.tv?.mapValues { list -> list.value.map { it.v1compat() } },
          ),
      )
  )

fun PackageVersionV2.v1compat() =
  copy(
    src = src?.v1compat(),
    manifest =
      manifest.copy(
        signer =
          if ((manifest.signer?.sha256?.size ?: 0) <= 1) manifest.signer
          else {
...
object TestDataEmptyV2 {
  ...
  val index = IndexV2(repo = repo, packages = emptyMap())
}
...
object TestDataMinV2 {
  ...
  val version =
    PackageVersionV2(
      ...
      manifest = ManifestV2(versionCode = 1, versionName = "0"),
    )
  val app =
    PackageV2(
      metadata =
      ...
      versions = mapOf(version.file.sha256 to version),
    )
  val packages = mapOf(PACKAGE_NAME to app)

  val index = IndexV2(repo = repo, packages = packages)
}
...
object TestDataMidV2 {
  ...
  val repo =
    RepoV2(
      timestamp = 1337,
      name = mapOf(LOCALE to "MidV1", "de" to "MitteV1"),
      icon =
        mapOf(
          LOCALE to
            FileV2(
    ...
    PackageVersionV2(
      ...
      manifest =
        ManifestV2(
          versionCode = 24,
          versionName = "24",
          usesSdk = UsesSdkV2(minSdkVersion = 21, targetSdkVersion = 32),
          maxSdkVersion = 4568,
          signer =
            SignerV2(
              sha256 = listOf("824a109b2352138c3699760e1683385d0ed50ce526fc7982f8d65757743374bf")
            ),
          features = listOf(FeatureV2("new feature")),
        ),
      src =
        FileV2(
  ...
  val version1_2Compat =
    version1_2.v1compat().copy(antiFeatures = mapOf("AntiFeature" to emptyMap()))
    ...
    PackageV2(
      metadata =
        MetadataV2(
          ...
          summary = mapOf(LOCALE to "App1 summary", "de" to "App1 Zusammenfassung"),
          description = mapOf(LOCALE to "App1 description", "de" to "App1 beschreibung"),
          name = mapOf(LOCALE to "App1", "de" to "app 1 name"),
      ...
      versions = mapOf(version1_1.file.sha256 to version1_1, version1_2.file.sha256 to version1_2),
    )
  val app1Compat =
    app1
      .v1compat(true)
    ...
    PackageVersionV2(
      ...
      manifest =
        ManifestV2(
          versionCode = 1014050,
          versionName = "1.14",
          usesSdk = UsesSdkV2(minSdkVersion = 22, targetSdkVersion = 25),
          signer =
            SignerV2(
          ...
          usesPermissionSdk23 =
            listOf(PermissionV2(name = "android.permission.ACCESS_COARSE_LOCATION")),
        ),
      src =
        FileV2(
        ...
        MetadataV2(
          ...
          description =
            mapOf(
              ...
              "cy" to
                "Mae F-Droid yn gatalog y gellir ei osod o apiau meddalwedd " +
                ...
                mapOf(
                  LOCALE to
                    listOf(
                      FileV2(
                        name =
                          "/org.fdroid.fdroid/en-US/phoneScreenshots/" +
                            "screenshot-app-details.png",
                        sha256 =
                          "424a109b2352138c3699760e1683385d" + "0ed50ce526fc7982f8d65757743374bf",
                        size = 4237,
                      ),
                      FileV2(
                        name =
                      ...
                      FileV2(
                        name =
                          "/org.fdroid.fdroid/en-US/phoneScreenshots/" + "screenshot-dark-home.png",
                        sha256 =
                          "424a109b2352138c3699760e1673385d" + "0ed50ce526fc7982f8d65757743374bf",
                        size = 4587,
                      ),
                      FileV2(
                        name =
                      ...
                      FileV2(
                        name =
                          "/org.fdroid.fdroid/en-US/phoneScreenshots/" + "screenshot-knownvuln.png",
                        sha256 =
                          "424a109b2352138c4599760e1683385d" + "0ed50ce526fc7982f8d65757743374bf",
                        size = 4287,
                      ),
                      FileV2(
                        name =
                          "/org.fdroid.fdroid/en-US/phoneScreenshots/" + "screenshot-search.png",
                        sha256 =
                          "424a109b2352138c3694760e1683385d" + "0ed50ce526fc7982f8d65757743374bf",
                        size = 2857,
                      ),
                      FileV2(
                        name =
                          "/org.fdroid.fdroid/en-US/phoneScreenshots/" + "screenshot-updates.png",
                        sha256 =
                          "424a109b2352138c3699750e1683385d" + "0ed50ce526fc7982f8d65757743374bf",
                        size = 485287,
                      ),
                    )
                )
  ...
  val indexCompat =
    index.copy(
      repo = repoCompat,
      packages = mapOf(PACKAGE_NAME_1 to app1Compat, PACKAGE_NAME_2 to app2Compat),
    )
}
...
object TestDataMaxV2 {
    ...
    RepoV2(
      ...
      antiFeatures =
        mapOf(
          ...
          "Dont,Show,This" to AntiFeatureV2(name = emptyMap()),
          "NotNice" to AntiFeatureV2(name = emptyMap()),
          "AntiFeature" to
            AntiFeatureV2(
              icon =
                mapOf(
          ...
          "NonFreeNet" to AntiFeatureV2(name = mapOf(LOCALE to "NonFreeNet")),
          "AddOne" to
            AntiFeatureV2(
      ...
      categories =
        mapOf(
          ...
          "NoMoreSystem" to CategoryV2(name = emptyMap()),
          "OneMore" to CategoryV2(name = emptyMap()),
        ),
      releaseChannels =
        mapOf(
          "Alpha" to
  ...
  val repoCompat =
    repo
      ...
      .copy(
        ...
        categories =
          mapOf("Cat1" to CategoryV2(name = emptyMap()), "System" to CategoryV2(name = emptyMap())),
        antiFeatures = mapOf("AntiFeature" to AntiFeatureV2(name = emptyMap())),
      )

  const val PACKAGE_NAME_1 = TestDataMidV2.PACKAGE_NAME_1
  const val PACKAGE_NAME_2 = TestDataMidV2.PACKAGE_NAME_2
  const val PACKAGE_NAME_3 =
  ...
  val version2_2 =
    TestDataMidV2.version2_2.copy(
      manifest =
        TestDataMidV2.version2_2.manifest.copy(
          usesPermission = emptyList(),
          usesPermissionSdk23 = emptyList(),
          nativecode = emptyList(),
          features = emptyList(),
        ),
      antiFeatures = mapOf("AddOne" to mapOf(LOCALE to "was added this update")),
      releaseChannels = listOf(RELEASE_CHANNEL_BETA),
    )
  val version2_3 =
    TestDataMidV2.version2_3.copy(
      manifest =
        TestDataMidV2.version2_3.manifest.copy(
          versionCode = 1014003,
          versionName = "1.14-alpha3",
          usesSdk = UsesSdkV2(minSdkVersion = 22, targetSdkVersion = 25),
          signer =
      ...
      file = TestDataMidV2.version2_3.file.copy(size = 8276110),
      src = TestDataMidV2.version2_3.src?.copy(name = "/org.fdroid.fdroid_1014003_src.tar.gz"),
      antiFeatures = mapOf("AddOne" to mapOf(LOCALE to "was added this update")),
      whatsNew = mapOf("ch" to "This is new!", "de" to "das ist neu", "en-US" to "this is new"),
    )
  val version2_4 = TestDataMidV2.version2_4.copy(antiFeatures = mapOf("AddOne" to emptyMap()))
  val version2_5 =
    TestDataMidV2.version2_5.copy(
      antiFeatures = mapOf("AddOne" to mapOf(LOCALE to "was added this update"))
    )
  val app2 =
    TestDataMidV2.app2.copy(
      metadata =
        TestDataMidV2.app2.metadata.copy(
          ...
          name = mapOf(LOCALE to "F-DroidX", "ch" to "new name"),
          icon =
            mapOf(
              LOCALE to
                FileV2(
          ...
          screenshots =
            TestDataMidV2.app2.metadata.screenshots?.copy(
              phone =
                mapOf(
                  LOCALE to
                    listOf(
                  ...
                  "ch" to
                    listOf(
                      FileV2(
                        ...
                        sha256 =
                          "54758e380ae76297c7947f107db9ea03" + "d2933c9d5c110d02046977cf78d43def",
                        size = Long.MIN_VALUE,
                      )
                    )
                ),
  ...
  val app3 =
    PackageV2(
      metadata =
        MetadataV2(
          name = mapOf(LOCALE to "App3", "en" to "en ", "zh-CN" to "自由软件仓库"),
          summary = mapOf(LOCALE to "App3 summary", "en" to "en ", "ja" to "这个仓库中的"),
          description = mapOf(LOCALE to "App3 description", "en" to "en ", "ko-KR" to "切始终是从"),
          added = 1234567890,
          ...
          icon =
            mapOf(
              "en" to
                FileV2(
                  name =
                    "/Haoheiseeshai2que2Che0ooSa6aikeemoo2ap9Aequoh4ju5chooYuPhiev8moodahl" +
                ...
                mapOf(
                  "en" to
                    listOf(
                      FileV2(
                        name =
                          "/Haoheiseeshai2que2Che0ooSa6aikeemoo2ap9Aequoh4ju5chooYuPhiev" +
                        ...
                        sha256 =
                          "54758e380aee6297c7947f107db9ea03" + "d2933c9d5c110d02046977cf78d43def",
                        size = 0,
                      ),
                      FileV2(
                        name =
      ...
      versions = mapOf(version3_1.file.sha256 to version3_1),
    )
  val app3Compat =
    app3.v1compat(true).copy(versions = mapOf(version3_1.file.sha256 to version3_1.v1compat()))
