...
object TestDataMidV1 {
      ...
      localized =
        mapOf(
          ...
          "cy" to
            Localized(
              description =
                "Mae F-Droid yn gatalog y gellir ei osod o apiau meddalwedd rhydd" +
                  "ar gyfer Android.",
              name = "F-Droid",
  ...
  val packages = mapOf(PACKAGE_NAME_1 to versions1, PACKAGE_NAME_2 to versions2)
...
object TestDataMaxV1 {
  ...
  val app3 =
    AppV1(
      ...
      localized =
        mapOf(
          LOCALE to Localized(whatsNew = "this is new"),
          "de" to Localized(whatsNew = "das ist neu"),
          "en" to
            Localized(
              description = "en ",
              name = "en ",
              ...
              sevenInchScreenshots = listOf("en sevenInchScreenshots", "en sevenInchScreenshots2"),
  ...
  val versions2 = listOf(version2_2, version2_3, TestDataMidV1.version2_4, TestDataMidV1.version2_5)
  val versions3 = listOf(version3_1)
  val packages =
    mapOf(PACKAGE_NAME_1 to versions1, PACKAGE_NAME_2 to versions2, PACKAGE_NAME_3 to versions3)
