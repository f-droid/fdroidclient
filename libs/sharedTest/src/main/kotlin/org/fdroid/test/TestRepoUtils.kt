...
object TestRepoUtils {
  ...
  fun getRandomMirror(): MirrorV2 =
    MirrorV2(url = getRandomString(), countryCode = getRandomString().orNull())

  fun getRandomLocalizedTextV2(size: Int = Random.nextInt(0, 23)): LocalizedTextV2 = buildMap {
    repeat(size) { put(getRandomString(4), getRandomString()) }
  }
  ...
  fun getRandomLocalizedFileV2(): Map<String, FileV2> =
    TestUtils.getRandomMap(Random.nextInt(1, 8)) { getRandomString(4) to getRandomFileV2() }
