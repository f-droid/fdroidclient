...
public class PreferencesFragment extends PreferenceFragmentCompat
    ...
    public void onCreatePreferences(Bundle bundle, String s) {
        ...
        keepInstallHistoryPref = (SwitchPreferenceCompat) findPreference(Preferences.PREF_KEEP_INSTALL_HISTORY);
    ...
    private void updateSummary(String key, boolean changing) {
        ...
        switch (key) {
            ...
            case Preferences.PREF_PRIVILEGED_INSTALLER:
                ...
                final SwitchPreferenceCompat pref = (SwitchPreferenceCompat) findPreference(
                        Preferences.PREF_PRIVILEGED_INSTALLER);
                if (pref != null) {
