    ...
    public void updateItems(@NonNull App app, @NonNull List<Apk> apks, @NonNull AppPrefs appPrefs) {
        ...
        for (final Apk apk : apks) {
            ...
            if (allowByCompatibility) {
                ...
                if (allowBySig) {
                    versions.add(apk);
                    if (!versionsExpandTracker.containsKey(apk.apkFile.getName())) {
                        versionsExpandTracker.put(apk.apkFile.getName(), false);
                    }
                }
            }
        }
    ...
    private class VersionViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bindModel(final Apk apk) {
            ...
            boolean isApkDownloading = callbacks.isAppDownloading() && downloadedApk != null &&
                    ...
                    TextUtils.equals(apk.apkFile.getName(), downloadedApk.apkFile.getName());
            ...
            expand(versionsExpandTracker.get(apk.apkFile.getName()) || isApkDownloading);
        ...
        private void expand(boolean expand) {
            versionsExpandTracker.put(apk.apkFile.getName(), expand);
        ...
        private void toggleExpanded() {
            ...
            boolean expand = !versionsExpandTracker.get(apk.apkFile.getName());
            expand(expand);
