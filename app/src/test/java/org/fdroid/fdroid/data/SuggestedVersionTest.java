...
public class SuggestedVersionTest extends FDroidProviderTest {
    ...
    public void singleRepoSingleSig() {
        ...
        App found2 = AppProvider.Helper.findSpecificApp(context.getContentResolver(), singleApp.packageName, singleApp.repoId);
        ...
        AppProvider.Helper.calcSuggestedApks(context);
        App found3 = AppProvider.Helper.findSpecificApp(context.getContentResolver(), singleApp.packageName, singleApp.repoId);
    ...
    public void singleRepoMultiSig() {
        ...
        App suggestUpstream4 = AppProvider.Helper.findSpecificApp(context.getContentResolver(), singleApp.packageName, singleApp.repoId);
        ...
        AppProvider.Helper.calcSuggestedApks(context);
        App suggestFDroid3 = AppProvider.Helper.findSpecificApp(context.getContentResolver(), singleApp.packageName, singleApp.repoId);
        ...
        AppProvider.Helper.calcSuggestedApks(context);
        App suggestFDroid4 = AppProvider.Helper.findSpecificApp(context.getContentResolver(), singleApp.packageName, singleApp.repoId);
        ...
        Preferences.get().setUnstableUpdates(true);
        AppProvider.Helper.calcSuggestedApks(context);
        App suggestFDroid5 = AppProvider.Helper.findSpecificApp(context.getContentResolver(), singleApp.packageName, singleApp.repoId);
    ...
    private App insertApp(Context context, String packageName, String appName, int upstreamVersionCode, String repoUrl) {
